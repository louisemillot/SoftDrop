...
R=$(jq -r '.["my-custom-task"].R' "../dpl-config_Run2.json")
ptmin=$(jq -r '.["my-custom-task"].ptmin' "../dpl-config_Run2.json")
z_cut=$(jq -r '.["my-custom-task"].z_cut' "../dpl-config_Run2.json")
beta=$(jq -r '.["my-custom-task"].beta' "../dpl-config_Run2.json")
n=$(jq -r '.["my-custom-task"].n' "../dpl-config_Run2.json")
