...
options0=" --configuration json://../dpl-Run3_pp.json"
...
# o2-analysis-je-recursive-softdrop ${jsonsArray[$i]} | \

o2-analysis-je-softdrop ${jsonsArray[$i]} | \
...
o2-analysis-je-subtractor-eventwiseconstituent ${jsonsArray[$i]} | \

o2-analysis-je-jet-substructure-softdrop ${jsonsArray[$i]} &> log_run3_pp.txt
